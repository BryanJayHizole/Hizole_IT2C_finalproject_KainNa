			...
			<div class="menu-container">
				...
				<div class="menus d-flex ftco-animate">
					...
					<div class="text">
						<div class="d-flex">
							<div class="one-half">
								<h3>Beef and Mushroom with Smashed Potatoes</h3>
							</div>
							<div class="one-forth">
				...
				<div class="menus d-flex ftco-animate">
					...
					<div class="text">
						<div class="d-flex">
							<div class="one-half">
								<h3>Potluck Macaroni and Cheese</h3>
							</div>
							<div class="one-forth">
				...
				<div class="menus d-flex ftco-animate">
					...
					<div class="text">
						<div class="d-flex">
							<div class="one-half">
								<h3>Brocolli Chicken Casserole</h3>
							</div>
							<div class="one-forth">
